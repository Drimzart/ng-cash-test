export default () => {
  return (
    <div className="font-manrope flex  items-center justify-center h-max">
  <div className="box-border w-full border bg-white p-4">
    ...
    <div className="mt-6">
      ...
      <div className="flex justify-between">
        <div className="mt-[14px] cursor-pointer truncate rounded-[4px] border border-[#E7EAEE] hover:border-green-700 p-3 text-[#191D23]">$10.00</div>
        <div className="mt-[14px] cursor-pointer truncate rounded-[4px] border border-[#E7EAEE] hover:border-green-700 p-3 text-[#191D23]">$50.00</div>
        <div className="mt-[14px] cursor-pointer truncate rounded-[4px] border border-[#E7EAEE] hover:border-green-700 p-3 text-[#191D23]">$100.00</div>
        <div className="mt-[14px] cursor-pointer truncate rounded-[4px] border border-[#E7EAEE] hover:border-green-700 p-3 text-[#191D23]">$200.00</div>
      </div>
    </div>
      ...
      <div className="mt-2">
        <div className="flex w-full items-center justify-between bg-neutral-100 p-3 rounded-[4px]">
          <div className="flex items-center gap-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div className="mt-6">
      <div className="flex justify-between">
        ...
        <div className="flex cursor-pointer items-center gap-x-2">
          ...
          <div className="font-semibold text-green-500">Add contact</div>
        </div>
      </div>
    ...
    <div className="mt-6">
      <div className="w-full cursor-pointer rounded-[4px] bg-green-500 px-3 py-[6px] text-center font-semibold text-white">Send $100.00</div>
    </div>
  </div>
</div>
  )
