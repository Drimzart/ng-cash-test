                    ...
                    <table className="table-auto w-full">
                        ...
                        <tbody className="text-sm divide-y divide-gray-100">
                            <tr>
                                ...
                                <td className="p-2 whitespace-nowrap">
                                    <div className="text-sm font-medium text-center">09/08/2022</div>
                                </td>
                            </tr>
                            <tr>
                                <td className="p-2 whitespace-nowrap">
                                ...
                                <td className="p-2 whitespace-nowrap">
                                    <div className="text-center font-medium">02/07/2021</div>
                                </td>
                            </tr>
                            <tr>
                                <td className="p-2 whitespace-nowrap">
                                ...
                                <td className="p-2 whitespace-nowrap">
                                    <div className="text-left font-medium text-red-500">-$2,996.00</div>
                                </td>
                                <td className="p-2 whitespace-nowrap">
                                    <div className="text-sm font-medium text-center">11/06/2022</div>
                                </td>
                            </tr>
                            <tr>
                                <td className="p-2 whitespace-nowrap">
                                ...
                                <td className="p-2 whitespace-nowrap">
                                    <div className="text-left font-medium text-red-500">-$1,220.66</div>
                                </td>
                                <td className="p-2 whitespace-nowrap">
                                    <div className="text-sm font-medium text-center">01/05/2022</div>
                                </td>
                            </tr>
                            <tr>
                                <td className="p-2 whitespace-nowrap">
